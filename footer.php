    ...
    <footer class="footer">
      <div class="sponsors">
        ...
        <ul class="sponsors-list">
          <li class="sponsor"><a href="https://www.rotarybhm.org/?utm_source=rotaractbhm&utm_medium=sponsors&utm_campaign=referrals" target="_blank" rel="noopener"><img src="<?php bloginfo('template_url'); ?>/assets/images/rotary.svg" alt="Rotary Club of Birmingham" width="auto" height="42"></a></li>
          <li class="sponsor"><a href="https://www.rotarybhm.org/?utm_source=rotaractbhm&utm_medium=sponsors&utm_campaign=referrals" target="_blank" rel="noopener"><img src="<?php bloginfo('template_url'); ?>/assets/images/rotary.svg" alt="Rotary Club of Birmingham" width="auto" height="42"></a></li>
          <li class="sponsor"><a href="https://www.rotarybhm.org/?utm_source=rotaractbhm&utm_medium=sponsors&utm_campaign=referrals" target="_blank" rel="noopener"><img src="<?php bloginfo('template_url'); ?>/assets/images/rotary.svg" alt="Rotary Club of Birmingham" width="auto" height="42"></a></li>
          <li class="sponsor"><a href="https://www.rotarybhm.org/?utm_source=rotaractbhm&utm_medium=sponsors&utm_campaign=referrals" target="_blank" rel="noopener"><img src="<?php bloginfo('template_url'); ?>/assets/images/rotary.svg" alt="Rotary Club of Birmingham" width="auto" height="42"></a></li>
          <li class="sponsor"><a href="https://www.rotarybhm.org/?utm_source=rotaractbhm&utm_medium=sponsors&utm_campaign=referrals" target="_blank" rel="noopener"><img src="<?php bloginfo('template_url'); ?>/assets/images/rotary.svg" alt="Rotary Club of Birmingham" width="auto" height="42"></a></li>
      ...
      <div class="sitemap">
        ...
        <div class="newsletter">
          ...
          <p>Each month we send out our club bulletin updating you on the latest programming information, upcoming events and member activity. Get involved &ndash; subscribe today.</p>
        ...
        <div class="legal">
          <img class="legal-logo" src="<?php bloginfo('template_url'); ?>/assets/images/rotaract-icon.svg" alt="Rotaract Club of Birmingham" width="auto" height="42">
