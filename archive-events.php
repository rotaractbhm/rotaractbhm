<?php get_header(); ?>
  <article class="page">
    <header class="section">
      <div class="container">
        <h1 class="heading text-xxxxxl">Upcoming Events</h1>
        <p class="text-xl text-light color-gray-8 text-contain">The Rotaract Club of Birmingham meets on the first and third Thursdays each month at the Harbert Center in downtown Birmingham to hear from community and business leaders.</p>
      </div>
    </header>
      ...
      <div class="container">
        <div class="signature-events">
          <div class="signature-event">
            ...
            <a class="button button-base button-smaller" href="<?php echo get_permalink(""); ?>">Event Info</a>
          </div>
          <div class="signature-event">
