...
<main class="main" role="main">
  ...
  <div class="main-section">
    <div class="main-section-header main-section-header--centered">
      <h2 class="heading main-section-heading">Past Boards</h2>
    </div>
    <div class="boards">
      <div class="board">
        <div class="board-header">
          <h6 class="heading board-term">2018-2019</h6>
      ...
      <div class="board">
        <div class="board-header">
          <h6 class="heading board-term">2017-2018</h6>
          <a class="board-links" href="<?php echo get_permalink(""); ?>">Year In Review&nbsp;&nbsp;<i class="far fa-long-arrow-right"></i></a>
        </div>
        <dl class="board-directors">
          <div class="board-director">
      ...
      <div class="board">
        <div class="board-header">
          <h6 class="heading board-term">2016-2017</h6>
          <a class="board-links" href="<?php echo get_permalink(""); ?>">Year In Review&nbsp;&nbsp;<i class="far fa-long-arrow-right"></i></a>
        </div>
        <dl class="board-directors">
          <div class="board-director">
      ...
      <div class="board">
        <div class="board-header">
          <h6 class="heading board-term">2015-2016</h6>
          <a class="board-links" href="<?php echo get_permalink(""); ?>">Year In Review&nbsp;&nbsp;<i class="far fa-long-arrow-right"></i></a>
        </div>
        <dl class="board-directors">
          <div class="board-director">
      ...
      <div class="board">
        <div class="board-header">
          <h6 class="heading board-term">2014-2015</h6>
          <a class="board-links" href="<?php echo get_permalink(""); ?>">Year In Review&nbsp;&nbsp;<i class="far fa-long-arrow-right"></i></a>
        </div>
        <dl class="board-directors">
          <div class="board-director">
      ...
      <div class="board">
        <div class="board-header">
          <h6 class="heading board-term">2013-2014</h6>
          <a class="board-links" href="<?php echo get_permalink(""); ?>">Year In Review&nbsp;&nbsp;<i class="far fa-long-arrow-right"></i></a>
        </div>
        <dl class="board-directors">
          <div class="board-director">
      ...
      <div class="board">
        <div class="board-header">
          <h6 class="heading board-term">2012-2013</h6>
          <a class="board-links" href="<?php echo get_permalink(""); ?>">Year In Review&nbsp;&nbsp;<i class="far fa-long-arrow-right"></i></a>
        </div>
        <dl class="board-directors">
          <div class="board-director">
      ...
      <div class="board">
        <div class="board-header">
          <h6 class="heading board-term">2011-2012</h6>
          <a class="board-links" href="<?php echo get_permalink(""); ?>">Year In Review&nbsp;&nbsp;<i class="far fa-long-arrow-right"></i></a>
        </div>
        <dl class="board-directors">
          <div class="board-director">
      ...
      <div class="board">
        <div class="board-header">
          <h6 class="heading board-term">2010-2011</h6>
          <a class="board-links" href="<?php echo get_permalink(""); ?>">Year In Review&nbsp;&nbsp;<i class="far fa-long-arrow-right"></i></a>
        </div>
        <dl class="board-directors">
          <div class="board-director">
      ...
      <div class="board">
        <div class="board-header">
          <h6 class="heading board-term">2009-2010</h6>
          <a class="board-links" href="<?php echo get_permalink(""); ?>">Year In Review&nbsp;&nbsp;<i class="far fa-long-arrow-right"></i></a>
        </div>
        <dl class="board-directors">
          <div class="board-director">
      ...
      <div class="board">
        <div class="board-header">
          <h6 class="heading board-term">2008-2009</h6>
          <a class="board-links" href="<?php echo get_permalink(""); ?>">Year In Review&nbsp;&nbsp;<i class="far fa-long-arrow-right"></i></a>
        </div>
        <dl class="board-directors">
          <div class="board-director">
      ...
      <div class="board">
        <div class="board-header">
          <h6 class="heading board-term">2007-2008</h6>
          <a class="board-links" href="<?php echo get_permalink(""); ?>">Year In Review&nbsp;&nbsp;<i class="far fa-long-arrow-right"></i></a>
        </div>
        <dl class="board-directors">
          <div class="board-director">
      ...
      <div class="board">
        <div class="board-header">
          <h6 class="heading board-term">2006-2007</h6>
          <a class="board-links" href="<?php echo get_permalink(""); ?>">Year In Review&nbsp;&nbsp;<i class="far fa-long-arrow-right"></i></a>
        </div>
        <dl class="board-directors">
          <div class="board-director">
      ...
      <div class="board">
        <div class="board-header">
          <h6 class="heading board-term">2005-2006</h6>
          <a class="board-links" href="<?php echo get_permalink(""); ?>">Year In Review&nbsp;&nbsp;<i class="far fa-long-arrow-right"></i></a>
        </div>
        <dl class="board-directors">
          <div class="board-director">
      ...
      <div class="board">
        <div class="board-header">
          <h6 class="heading board-term">2004-2005</h6>
          <a class="board-links" href="<?php echo get_permalink(""); ?>">Year In Review&nbsp;&nbsp;<i class="far fa-long-arrow-right"></i></a>
        </div>
        <dl class="board-directors">
          <div class="board-director">
